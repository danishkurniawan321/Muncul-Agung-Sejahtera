...
class AccountMove(models.Model):
    ...
    def _compute_amount(self):
        ...
        # di modul poin of sale diubah jadi paid. harus dikembalikan ke status asal
        invoice_ids = [move.id for move in self if move.id and move.is_invoice(include_receipts=True) and move.type in ['out_invoice', 'out_refund'] and move.pos_order_ids]
